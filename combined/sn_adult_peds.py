...
for i in range(len(mask_dataset3)):
    for j in range(mask_dataset3[i].shape[2]):
        if mask_filenames3[i] == 'f_3325' and j==31:
            continue
        else:
...
image_directory = 'PEDIATRIC/Anatomical_mag_echo5/'
mask_directory = 'PEDIATRIC/whole_liver_segmentations/'
image_dataset2 = []  
mask_dataset2 = []
...
for i, (train_index, test_index) in enumerate(kf.split(sliced_image_dataset, sliced_mask_dataset)):
    ...
    f = open("C:/Users/Mittal/Desktop/2Dsegnet_both/test_index.txt", "a")
    ...
    plt.xlabel('Epoch')
    plt.tight_layout()
    plt.savefig(f'C:/Users/Mittal/Desktop/2Dsegnet_both/process{i}.png')
    plt.close()
    ...
    f = open("C:/Users/Mittal/Desktop/2Dsegnet_both/output.txt", "a")
    ...
    model.load_weights(f'C:/Users/Mittal/Desktop/2Dsegnet_both/best_model{i}.keras')
    ...
    for z in range(10):
        ...
        plt.savefig(f'C:/Users/Mittal/Desktop/2Dsegnet_both/predict/fold{i}_{z}.png')
        plt.close()
