...
for i in range(len(image_dataset2)):
    for j in range(image_dataset2[i].shape[2]):
        ...
        image_slice_id2 = f'{image_filenames[i]}-slice{j}'
...
plt.xlabel('Epoch')
plt.tight_layout()
plt.savefig(f'C:/Users/Mittal/Desktop/segnet-pediatric/process{i}.png')
plt.close()
...
f = open("C:/Users/Mittal/Desktop/segnet-pediatric/output.txt", "a")
...
model.load_weights(f'C:/Users/Mittal/Desktop/segnet-pediatric/best_model{i}.keras')
...
for z in range(10):
    ...
    plt.savefig(f'C:/Users/Mittal/Desktop/segnet-pediatric/predict/fold{i}_{z}.png')
    plt.close()
